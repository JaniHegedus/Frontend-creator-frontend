    ...
    return (
        <div className="flex flex-col bg-gray-200 dark:bg-gray-800 text-gray-900 dark:text-white">
            ...
            <div  className="flex justify-center items-center bg-gray-300 dark:bg-gray-700 p-1">
                <Image src={"/Frontend_Creator.png"} alt="Hero" className="rounded-lg shadow-lg w-10 h-10"/>
            </div>
            ...
            <div className="bg-gray-300 dark:bg-gray-700 p-10">
                ...
                <div className="max-w-4xl mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    ...
                    <div className="flex flex-col items-center">
                        <Image src={`./${DIR}/Project-Initer.png`} alt="Init" className="w-60 h-40 mb-4"/>
                        <p>Init your Project.</p>
                    </div>
                    {/* Step 2 */}
                    <div className="flex flex-col items-center">
                        <Image src={`./${DIR}/Image Editor.png`} alt="Upload or create" className="w-60 h-40 mb-4"/>
                        <p>Upload a picture or start from scratch.</p>
                    </div>
                    {/* Step 3 */}
                    <div className="flex flex-col items-center">
                        <Image src={`./${DIR}/Language.png`} alt="Customize" className="w-60 h-40 mb-4"/>
                        <p>Chose Generation Languages.</p>
                    </div>
                    {/* Step 4 */}
                    <div className="flex flex-col items-center">
                        <Image src={`./${DIR}/Project Summarry.png`} alt="Deploy" className="w-60 h-40 mb-4"/>
                        <p>Summarize your project details and send to bot.</p>
                    </div>

                    {/* Step 5 */}
                    <div className="flex flex-col items-center">
                        <Image src={`./${DIR}/Code Editor.png`} alt="Code" className="w-60 h-40 mb-4"/>
                        <p>Edit your code.</p>
                    </div>
                    {/* Step  6*/}
                    <div className="flex flex-col items-center">
                        <Image src={`./${DIR}/Export.png`} alt="Deploy" className="w-60 h-40 mb-4"/>
